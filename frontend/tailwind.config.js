...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Dynamic — these respond to palette + dark mode via CSS variables
        ink:     "rgb(var(--color-ink-rgb) / <alpha-value>)",
        primary: "rgb(var(--accent-rgb-tw) / <alpha-value>)",
        // Semantic status (static; palette-independent by design)
        success:   "#98C062",
        warning:   "#EA9947",
        danger:    "#DF4585",
        secondary: "#B4427F",
